...
set rtl ../rtl
set compile_arg +define+INCLUDE_FILE="$rtl/includes/params.h"+TEST=1
...
set out_of_order_v_dir  $rtl/cores/out_of_order/src
set out_of_order_tb_dir $rtl/cores/out_of_order/tb
...
vlog -quiet $compile_arg $out_of_order_v_dir/*.v
vlog -quiet $compile_arg $out_of_order_tb_dir/*.v
